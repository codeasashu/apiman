...
)  # (api/config/settings/base.py - 3 = api/)
...
LOCAL_APPS = [
    # Custom apps go here
    "api.example.apps.ExampleConfig",
    "corsheaders",
]
...
MIDDLEWARE = [
    ...
    "api.middleware.MyOperatorMiddleware",
]
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_RENDERER_CLASSES': (
        'api.renderers.MyOperatorRenderer',
    ),
